...
import { LayoutDashboard, Users, GraduationCap, BookOpen, Settings, LogOut, HeartPulse, ShieldCheck, Calendar as CalendarIcon } from 'lucide-react';
import {
...
const links = [
  ...
  { title: 'Responsáveis', url: '/admin/responsaveis', icon: ShieldCheck },
  { title: 'Calendário', url: '/admin/calendario', icon: CalendarIcon },
